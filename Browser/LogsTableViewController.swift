...
class LogsTableViewController: UITableViewController, NavigationBarCustomizable {
    ...
    override func viewDidLoad() {
        ...
        customNavigationBar.title = "Logs"
        customNavigationBar.barTintColor = UIColor.orange
        
        tableView.estimatedRowHeight = 44;
        tableView.rowHeight = UITableViewAutomaticDimension
        tableView.register(UINib.init(nibName: "LogsTableViewCell", bundle: nil), forCellReuseIdentifier: "cell")
    }
